...
interface CollaboratorCommunicationScreenProps {
  onBack?: () => void;
}

export default function CollaboratorCommunicationScreen({ onBack }: CollaboratorCommunicationScreenProps) {
  // Estados principais
  ...
  const [expandedCategories, setExpandedCategories] = useState<string[]>(['gestores']);
  ...
  // Estados específicos para colaborador
  ...
  // Mock data de contatos para Colaborador (apenas gestores)

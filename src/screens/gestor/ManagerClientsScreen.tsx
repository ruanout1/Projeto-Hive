...
export default function ManagerClientsScreen({ onBack }: ManagerClientsScreenProps) {
  ...
  return (
    <div className="h-full bg-gray-50">
            ...
            filteredClients.map((client) => (
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  {/* Actions - GESTOR NÃO TEM BOTÃO EXCLUIR */}
      ...
      {/* Resto dos dialogs (Create/Edit, View) - MANTIDOS IGUAIS (sem Delete) */}
      {/* ... (mantenha os dialogs Create/Edit e View do código original) */}

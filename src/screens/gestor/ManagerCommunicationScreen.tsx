...
import { Send, Search, Plus, Phone, Video, MoreVertical, Paperclip, ChevronDown, ChevronRight, AlertCircle, AlertTriangle, UserX, Bell, Edit, Info, X } from 'lucide-react';
...
interface ManagerCommunicationScreenProps {
  onBack?: () => void;
}

export default function ManagerCommunicationScreen({ onBack }: ManagerCommunicationScreenProps) {
  ...
  // Mock data de contatos para Gestor

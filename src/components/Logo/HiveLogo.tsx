export default function HiveLogo() {
  return (
    <div className="flex flex-col items-center gap-3">
      {/* Ícone de colmeia abstrata - tamanho médio */}
      <div className="relative w-20 h-20">
        ...
        >
          {/* Camadas da colmeia - ovais empilhadas - escala aumentada */}
          {/* Camada superior */}
      ...
      {/* Texto HIVE maior e mais proeminente */}
      <div className="text-center">
        <h1 
          ...
          style={{ 
            fontWeight: 700,
            color: '#6400A4',
            textShadow: '0 2px 4px rgba(100, 0, 164, 0.2)'
          }}
        >
          HIVE
        </h1>

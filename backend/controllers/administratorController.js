...
// GET /api/admin/manager/categories
...
// POST /api/admin/manager/categories
...
// POST /api/admin/manager/catalog
...
// PUT /api/admin/manager/catalog/:id
...
// PUT /api/admin/manager/catalog/:id/status
...
// DELETE /api/admin/manager/catalog/:id
...
// GET /api/admin/manager/users/managers (Lista gestores disponíveis)
...
// GET /api/admin/manager/users/staff (Lista colaboradores disponíveis)
...
// PUT /api/admin/manager/teams/:id
...
// PUT /api/admin/manager/teams/:id/status
...
// DELETE /admin/api/manager/teams/:id
...
// DELETE /admin/api/manager/categories/:id

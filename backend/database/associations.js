...
function setupAssociations() {
  ...
  ServiceRequest.hasMany(ScheduleService, { foreignKey: 'service_request_id', as: 'scheduledServices' });
  ScheduleService.belongsTo(ServiceRequest, { foreignKey: 'service_request_id', as: 'serviceRequest' });
